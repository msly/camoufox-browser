...
describe("DaemonServer (lifecycle)", () => {
  ...
  it("accepts JSON-line commands and closes cleanly", async () => {
    const server = new DaemonServer({ exitOnShutdown: false });
